            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <button type="button" class="position-relative float-end shopping-cart" onclick="openNav()">
                        ...
                        <span class="position-absolute shopping-cart-badge">2
                        </span>
                    </button>
            ...
            <div class="d-flex align-items-start">
                <div class="nav flex-column nav-pills me-3 cafe-pill" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <asp:ListView ID="ListView1" runat="server" Visible="false">
                        <LayoutTemplate>
                            <div class="nav-link light-text cafenav">
                                <asp:PlaceHolder ID="itemPlaceholder" runat="server" />
                            </div>
                        </LayoutTemplate>
                        <ItemTemplate>
                            <div class="nav-link light-text cafenav">
                                <asp:LinkButton ID="lnkItemDesc" runat="server" Text='<%# Eval("ItemDesc")%>' OnClick="lnkItemDesc_Click"></asp:LinkButton>
                            </div>
                        </ItemTemplate>
                        <AlternatingItemTemplate>
                            <div class="nav-link light-text cafenav">
                               <asp:LinkButton ID="lnkItemDesc" runat="server" Text='<%# Eval("ItemDesc")%>'></asp:LinkButton>
                            </div>
                        </AlternatingItemTemplate>
                        <EmptyDataTemplate>
                            No records found
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div>Same user as Success per login</div>
                                        </td>
                                        <td>
                                            <div>1</div>
                                        </td>
