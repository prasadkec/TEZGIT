<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="TEZBI.ChangePassword" %>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                                        ...
                                        <h1 class="m-2 mb-4"><span class="playfair-font">Change Password</span></h1>
                                    </div>
                                    <div class="col-lg-5 col-md-12 col-sm-12 col-12 m-auto">
                                        ...
                                        <div class="mb-4">
                                            <asp:TextBox ID="txtNewPassword" runat="server" autocomplete="off" CssClass="form-control cafe-input-grey" Placeholder="Enter the New Password" Width="100%"></asp:TextBox>

                                        </div>
                                        <div class="mb-4">
                                            <asp:TextBox ID="txtRetypeNewPassword" runat="server" autocomplete="off" CssClass="form-control cafe-input-grey" Placeholder="ReType New Password" Width="100%" TextMode="Password"></asp:TextBox>

                                        </div>


                                        <asp:Button ID="btnChangePassword" runat="server" Text="Change password" CssClass="btn btn-primary cafe-btn me-0 me-lg-3 mb-2" OnClick="btnChangePassword_Click" />
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-10 col-md-12 col-sm-12 col-12 m-auto text-center mb-5">
                                <h4 class="cafe-success text-success">Password Changed Successfully!!!</h4>
                            </div>
                        </div>
                    </div>
                </div>
